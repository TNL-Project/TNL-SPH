...
void
SPHSimulation< Variables, ParticleSystem, NeighborSearch >::InteractLambda()
{
   ...
   Algorithms::ParallelFor< DeviceType >::exec( 0, numberOfParticles, particleLoop, this->neighborSearch );
}
