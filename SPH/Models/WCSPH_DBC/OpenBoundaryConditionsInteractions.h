...
//
//         Matrix A_local = 0.f;
//         VectorExtendedType rho_gradrho_local = 0.f;
//         VectorExtendedType vx_gradvx_local = 0.f;
//         VectorExtendedType vy_gradvy_local = 0.f;
//
//         A_local( 0, 0 ) = W * V;
//         A_local( 0, 1 ) = r_ij[ 0 ] * W * V;
//         A_local( 0, 2 ) = r_ij[ 1 ] * W * V;
//
//         A_local( 1, 0 ) = gradW[ 0 ] * V;
//         A_local( 1, 1 ) = r_ij[ 0 ] * gradW[ 0 ] * V;
//         A_local( 1, 2 ) = r_ij[ 1 ] * gradW[ 0 ] * V;
//
//         A_local( 2, 0 ) = gradW[ 1 ] * V;
//         A_local( 2, 1 ) = r_ij[ 0 ] * gradW[ 1 ] * V;
//         A_local( 2, 2 ) = r_ij[ 1 ] * gradW[ 1 ] * V;
//
//         rho_gradrho_local[ 0 ] = W * m;
//         rho_gradrho_local[ 1 ] = gradW[ 0 ] * m;
//         rho_gradrho_local[ 2 ] = gradW[ 1 ] * m;
//
//         vx_gradvx_local[ 0 ] = v_j[ 0 ] * W * V;
//         vx_gradvx_local[ 1 ] = gradW[ 0 ] * v_j[ 0 ] * V;
//         vx_gradvx_local[ 2 ] = gradW[ 1 ] * v_j[ 0 ] * V;
//
//         vy_gradvy_local[ 0 ] = v_j[ 1 ] * W * V;
//         vy_gradvy_local[ 1 ] = gradW[ 0 ] * v_j[ 1 ] * V;
//         vy_gradvy_local[ 2 ] = gradW[ 1 ] * v_j[ 1 ] * V;
//
//         *A_gn += A_local;
//         *rho_gradrho_gn += rho_gradrho_local;
//         *vx_gradvx_gn += vx_gradvx_local;
//         *vy_gradvy_gn += vy_gradvy_local;
//      }
//   };
//
//   auto particleLoopOpenBoundary = [=] __cuda_callable__ ( LocalIndexType i ) mutable
...
//         A_local( 2, 2 ) = r_ij[ 1 ] * gradW[ 1 ] * V;
//
//         rhogradrho_local[ 0 ] = W * m;
//         rhogradrho_local[ 1 ] = gradW[ 0 ] * m;
//         rhogradrho_local[ 2 ] = gradW[ 1 ] * m;
//
//         vxgradvx_local[ 0 ] = v_j[ 0 ] * W * V;
//         vxgradvx_local[ 1 ] = gradW[ 0 ] * v_j[ 0 ] * V;
//         vxgradvx_local[ 2 ] = gradW[ 1 ] * v_j[ 0 ] * V;
//
//         vygradvy_local[ 0 ] = v_j[ 1 ] * W * V;
//         vygradvy_local[ 1 ] = gradW[ 0 ] * v_j[ 1 ] * V;
//         vygradvy_local[ 2 ] = gradW[ 1 ] * v_j[ 1 ] * V;
//
//         *A_gn += A_local;
//         *rhogradrho_gn += rhogradrho_local;
//         *vxgradvx_gn += vxgradvx_local;
...
//   };
//
//} // if constexpr (if constexpr( SPHConfig::spaceDimension == 2 ) )
//
...
//                                                    VectorExtendedType* rhogradrho_gn,
//                                                    VectorExtendedType* vxgradvx_gn,
//                                                    VectorExtendedType* vygradvy_gn,
//                                                    VectorExtendedType* vzgradvz_gn ) mutable
//   {
//      const VectorType r_j = view_points[ j ];
//      const VectorType r_ij = r_i - r_j;
//      const RealType drs = l2Norm( r_ij );
...
//         A_local( 0, 1 ) = r_ij[ 0 ] * W * V;
//         A_local( 0, 2 ) = r_ij[ 1 ] * W * V;
//         A_local( 0, 3 ) = r_ij[ 2 ] * W * V;
//
//         A_local( 1, 0 ) = gradW[ 0 ] * V;
//         A_local( 1, 1 ) = r_ij[ 0 ] * gradW[ 0 ] * V;
//         A_local( 1, 2 ) = r_ij[ 1 ] * gradW[ 0 ] * V;
//         A_local( 1, 3 ) = r_ij[ 2 ] * gradW[ 0 ] * V;
//
//         A_local( 2, 0 ) = gradW[ 1 ] * V;
//         A_local( 2, 1 ) = r_ij[ 0 ] * gradW[ 1 ] * V;
//         A_local( 2, 2 ) = r_ij[ 1 ] * gradW[ 1 ] * V;
//         A_local( 2, 3 ) = r_ij[ 2 ] * gradW[ 1 ] * V;
//
//         A_local( 3, 0 ) = gradW[ 2 ] * V;
//         A_local( 3, 1 ) = r_ij[ 0 ] * gradW[ 2 ] * V;
//         A_local( 3, 2 ) = r_ij[ 1 ] * gradW[ 2 ] * V;
//         A_local( 3, 3 ) = r_ij[ 2 ] * gradW[ 2 ] * V;
//
//         rhogradrho_local[ 0 ] = W * m;
//         rhogradrho_local[ 1 ] = gradW[ 0 ] * m;
//         rhogradrho_local[ 2 ] = gradW[ 1 ] * m;
//         rhogradrho_local[ 3 ] = gradW[ 2 ] * m;
//
//         vxgradvx_local[ 0 ] = v_j[ 0 ] * W * V;
//         vxgradvx_local[ 1 ] = gradW[ 0 ] * v_j[ 0 ] * V;
//         vxgradvx_local[ 2 ] = gradW[ 1 ] * v_j[ 0 ] * V;
//         vxgradvx_local[ 3 ] = gradW[ 2 ] * v_j[ 0 ] * V;
//
//         vygradvy_local[ 0 ] = v_j[ 1 ] * W * V;
//         vygradvy_local[ 1 ] = gradW[ 0 ] * v_j[ 1 ] * V;
//         vygradvy_local[ 2 ] = gradW[ 1 ] * v_j[ 1 ] * V;
//         vygradvy_local[ 3 ] = gradW[ 2 ] * v_j[ 1 ] * V;
//
//         vzgradvz_local[ 0 ] = v_j[ 2 ] * W * V;
//         vzgradvz_local[ 1 ] = gradW[ 0 ] * v_j[ 2 ] * V;
//         vzgradvz_local[ 2 ] = gradW[ 1 ] * v_j[ 2 ] * V;
//         vzgradvz_local[ 3 ] = gradW[ 2 ] * v_j[ 2 ] * V;
//
//         *A_gn += A_local;
//         *rhogradrho_gn += rhogradrho_local;
//         *vxgradvx_gn += vxgradvx_local;
