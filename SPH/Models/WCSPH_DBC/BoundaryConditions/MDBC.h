...
class MDBCVariables : public SPHFluidVariables< SPHConfig >
{
public:
   using Base = SPHFluidVariables< SPHConfig >;
   ...
   MDBCVariables( GlobalIndexType size )
   : SPHFluidVariables< SPHConfig >( size ), ghostNodes( size ), ghostNodes_swap( size ) {}
...
{
   public:
   using Variables = MDBCVariables< SPHConfig >;
