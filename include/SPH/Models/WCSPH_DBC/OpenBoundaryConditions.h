...
typename VerletIntegrator< SPHConfig>::GlobalIndexType
VerletIntegrator< SPHConfig >::moveInletBufferParticles( RealType dt,
                                                         OpenBoundaryPointer& openBoundary )
{
   const GlobalIndexType numberOfBufferParticles = openBoundary->particles->getNumberOfParticles();
...
template< typename OpenBoundaryPointer >
typename VerletIntegrator< SPHConfig>::GlobalIndexType
VerletIntegrator< SPHConfig >::moveOutletBufferParticles( RealType dt,
                                                          OpenBoundaryPointer& openBoundary )
{
   GlobalIndexType numberOfBufferParticles = openBoundary->particles->getNumberOfParticles();
...
template< typename OpenBoundaryPointer >
void
VerletIntegrator< SPHConfig >::sortBufferParticlesByMark( OpenBoundaryPointer& openBoundary )
{
...
template< typename FluidPointer, typename OpenBoundaryPointer, typename OpenBoundaryParams >
void
VerletIntegrator< SPHConfig >::convertBufferToFluid( FluidPointer& fluid,
                                                     OpenBoundaryPointer& openBoundary,
                                                     OpenBoundaryParams& openBoundaryParams,
...
typename VerletIntegrator< SPHConfig>::GlobalIndexType
VerletIntegrator< SPHConfig >::getFluidParticlesEnteringOutlet( FluidPointer& fluid,
                                                                OpenBoundaryPointer& openBoundary )
{
...
template< typename FluidPointer, typename OpenBoundaryPointer >
void
VerletIntegrator< SPHConfig >::convertFluidToBuffer( FluidPointer& fluid,
                                                     OpenBoundaryPointer& openBoundary,
...
template< typename FluidPointer,
          ...
          typename OpenBCType,
          std::enable_if_t< std::is_same_v< OpenBCType, WCSPH_BCTypes::Inlet >, bool > Enabled >
void
VerletIntegrator< SPHConfig >::applyOpenBoundary( RealType dt,
                                                  FluidPointer& fluid,
                                                  OpenBoundaryPointer& openBoundary,
                                                  OpenBoundaryParams& openBoundaryParams )
{
...
template< typename FluidPointer,
          ...
          typename OpenBoundaryParams,
          typename OpenBCType,
          std::enable_if_t< std::is_same_v< OpenBCType, WCSPH_BCTypes::Outlet >, bool > Enabled >
void
VerletIntegrator< SPHConfig >::applyOpenBoundary( RealType dt,
                                                  FluidPointer& fluid,
                                                  OpenBoundaryPointer& openBoundary,
