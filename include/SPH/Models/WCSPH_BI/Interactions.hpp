...
template< typename FluidPointer,
          ...
          typename EOS >
void
WCSPH_BI< Particles, SPHState >::interaction( FluidPointer& fluid,
...
template< typename FluidPointer,
          ...
          typename EOS >
void
WCSPH_BI< Particles, SPHState >::updateSolidBoundary( FluidPointer& fluid,
                                                      BoudaryPointer& boundary,
                                                      SPHState& sphState )
{
   /* PARTICLES AND NEIGHBOR SEARCH ARRAYS */
...
void
WCSPH_BI< Particles, SPHState >::computePressureFromDensity( PhysicalObjectPointer& physicalObject, SPHState& sphState )
{
...
template< typename FluidPointer,
          ...
          typename EOS >
void
WCSPH_BI< ParticleSystem, SPHState >::interactionWithOpenBoundary( FluidPointer& fluid,
                                                                   ...
                                                                   SPHState& sphState )
{
   ...
   auto particleLoop = [=] __cuda_callable__ ( LocalIndexType i ) mutable
   {
      ...
      NeighborsLoopAnotherSet::exec( i, r_i, searchInOpenBoundary, FluidOpenBoundary, v_i, rho_i, p_i, &drho_i, &a_i, &gamma_i );
   ...
   auto particleLoopBoundary = [=] __cuda_callable__ ( LocalIndexType i ) mutable
   {
      ...
      NeighborsLoop::exec( i, r_i, searchInOpenBoundary, BoundOpenBoundary, &rho_i, &gamma_i );
...
void
WCSPH_BI< Particles, SPHState >::finalizeInteraction( FluidPointer& fluid,
                                                      BoundaryPointer& boundary,
                                                      SPHState& sphState )
{
   auto view_Drho = fluid->variables->drho.getView();
