...
void
WCSPH_BI< Particles, SPHState >::extrapolateOpenBoundaryData( FluidPointer& fluid,
...
template< typename FluidPointer, typename OpenBoudaryPointer >
void
WCSPH_BI< Particles, SPHState >::extrapolateOpenBoundaryData2D( FluidPointer& fluid,
                                                                OpenBoudaryPointer& openBoundary,
                                                                ModelParams& modelParams,
                                                                OpenBoundaryConfig& openBoundaryParams )
{
...
void
WCSPH_BI< Particles, SPHState >::extrapolateOpenBoundaryDensity2D( FluidPointer& fluid,
                                                                   OpenBoudaryPointer& openBoundary,
                                                                   ModelParams& modelParams,
                                                                   OpenBoundaryConfig& openBoundaryParams )
{
...
void
WCSPH_BI< Particles, SPHState >::extrapolateOpenBoundaryVelocity2D( FluidPointer& fluid,
                                                                    OpenBoudaryPointer& openBoundary,
                                                                    ModelParams& modelParams,
                                                                    OpenBoundaryConfig& openBoundaryParams )
{
...
template< typename FluidPointer, typename OpenBoudaryPointer >
void
WCSPH_BI< Particles, SPHState >::extrapolateOpenBoundaryData3D( FluidPointer& fluid,
                                                                OpenBoudaryPointer& openBoundary,
                                                                ModelParams& modelParams,
                                                                OpenBoundaryConfig& openBoundaryParams )
{
...
template< typename FluidPointer, typename OpenBoudaryPointer >
void
WCSPH_BI< Particles, SPHState >::extrapolateOpenBoundaryDensity3D( FluidPointer& fluid,
                                                                   OpenBoudaryPointer& openBoundary,
                                                                   ModelParams& modelParams,
                                                                   OpenBoundaryConfig& openBoundaryParams )
{
...
template< typename FluidPointer, typename OpenBoudaryPointer >
void
WCSPH_BI< Particles, SPHState >::extrapolateOpenBoundaryVelocity3D( FluidPointer& fluid,
                                                                    OpenBoudaryPointer& openBoundary,
                                                                    ModelParams& modelParams,
                                                                    OpenBoundaryConfig& openBoundaryParams )
{
