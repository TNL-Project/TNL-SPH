...
do
   ...
   do
      ...
      mv TNL-SPH_resources/time_measurements.json $resultsFolder/tnl-sph_${resolution}_${sample}.json
      mv TNL-SPH_resources/device.metadata.json $resultsFolder/tnl-sph_${resolution}_${sample}.device_metadata.json
      mv TNL-SPH_resources/case_metadata.json $resultsFolder/tnl-sph_${resolution}_${sample}.case_metadata.json
   done
done
