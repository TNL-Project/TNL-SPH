...
const std::string inputParticleFile = "damBreak3D_WCSPH-DBC/myFluidAscii.vtk";
const std::string inputParticleFile_bound = "damBreak3D_WCSPH-DBC/myBoundAscii.vtk";

const float endTime = 1.5;
