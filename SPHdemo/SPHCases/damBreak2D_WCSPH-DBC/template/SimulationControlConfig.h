...
class SPHSimulationControl
{
   ...
   const std::string inputParticleFile = "damBreak2D_WCSPH-DBC/dambreak_fluid.vtk";
   const std::string inputParticleFile_bound = "damBreak2D_WCSPH-DBC/dambreak_boundary.vtk";
