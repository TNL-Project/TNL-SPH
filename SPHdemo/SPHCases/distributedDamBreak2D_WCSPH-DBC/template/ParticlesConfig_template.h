 ...
 */
class ParticleInitialSetup_placeholderSubdomain
{
   public:
   ...
   static constexpr int numberOfAllocatedBoundaryParticles = placeholderAllocatedBoundaryParticles;
...
class ParticleSystemConfig_placeholderSubdomain
{
   public:
   ...
   using CellIndexerType = SimpleCellIndex< spaceDimension, ParticleSystemConfig_placeholderSubdomain, std::index_sequence< 1, 0 > >;
