...
#include "../../../SPH/Models/WCSPH_BI/PeriodicBoundaryConditions.h"
...
int main( int argc, char* argv[] )
{
    ...
    */
   TNL::Timer timer_interact, timer_integrate, timer_pressure;
   TNL::Timer timer_search, timer_search_reset, timer_search_cellIndices, timer_search_sort, timer_search_toCells;
   TNL::Timer timer_searchSecond, timer_searchSecond_reset, timer_searchSecond_cellIndices, timer_searchSecond_sort, timer_searchSecond_toCells;
   ...
   while( timeStepping.runTheSimulation() )
   {
       ...
       * Find neighbors within the SPH simulation.
       */
      timer_searchSecond.start();
      sph.PerformNeighborSearch(
            0, timer_searchSecond_reset, timer_searchSecond_cellIndices, timer_searchSecond_sort, timer_searchSecond_toCells );
      timer_searchSecond.stop();
    ...
    */
   float searchTotalTime = timer_search.getRealTime() + timer_searchSecond.getRealTime();
   float totalTime = ( searchTotalTime \
   ...
   std::cout << "Search total.................................. " << searchTotalTime << " sec." << std::endl;
   std::cout << "Search total (average time per step).......... " << searchTotalTime / steps << " sec." << std::endl;
   std::cout << "Search total (percentage)..................... " << searchTotalTime / totalTime * 100 << " %." << std::endl;
   ...
   std::cout << "Search - second one .......................... " << timer_searchSecond.getRealTime() << " sec." << std::endl;
   std::cout << "Search - second one (average time per step)... " << timer_searchSecond.getRealTime() / steps << " sec." << std::endl;
   std::cout << "Search - second one (percentage).............. " << timer_searchSecond.getRealTime() / totalTime * 100 << " %." << std::endl;
   std::cout << " - Reset ..................................... " << timer_searchSecond_reset.getRealTime() << " sec." << std::endl;
   std::cout << " - Reset (average time per step).............. " << timer_searchSecond_reset.getRealTime() / steps << " sec." << std::endl;
   std::cout << " - Reset (percentage)......................... " << timer_searchSecond_reset.getRealTime() / totalTime * 100 << " %." << std::endl;
   std::cout << " - Index by cell ............................. " << timer_searchSecond_cellIndices.getRealTime() << " sec." << std::endl;
   std::cout << " - Index by cell (average time per step)...... " << timer_searchSecond_cellIndices.getRealTime() / steps << " sec." << std::endl;
   std::cout << " - Index by cell (percentage)................. " << timer_searchSecond_cellIndices.getRealTime() / totalTime * 100 << " %." << std::endl;
   std::cout << " - Sort ...................................... " << timer_searchSecond_sort.getRealTime() << " sec." << std::endl;
   std::cout << " - Sort (average time per step)............... " << timer_searchSecond_sort.getRealTime() / steps << " sec." << std::endl;
   std::cout << " - Sort (percentage).......................... " << timer_searchSecond_sort.getRealTime() / totalTime * 100 << " %." << std::endl;
   std::cout << " - Particle to cell .......................... " << timer_searchSecond_toCells.getRealTime() << " sec." << std::endl;
   std::cout << " - Particle to cell (average time per step)... " << timer_searchSecond_toCells.getRealTime() / steps << " sec." << std::endl;
   std::cout << " - Particle to cell (percentage).............. " << timer_searchSecond_toCells.getRealTime() / totalTime * 100 << " %." << std::endl;
