...
#include "GenerateCellIndexFloating.h"
#include "Particles.h"
...
public:
   ...
   /**
    * Get and set index of first and last active particle.
    * The particle array is allocated with bigger size then is
    * the actual number of particles and we keep small empty buffer
    * at the start and at the and of the allocated array.
    */
   ...
   /**
    * Get and set the size of the grid
    */
...
#include "ParticlesLinkedListFloating.hpp"
