...
# list of tests
import my_wcsph_bi_2d_dam_break_configurations
conf_list = my_wcsph_bi_2d_dam_break_configurations.configurations
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--backup-results", default=True, action=argparse.BooleanOptionalAction, help="save all results" )

    # parse the command line arguments
    args = argparser.parse_args()
    backup_the_results = args.backup_results
