...
CXXFLAGS += -I/usr/local/Cellar/googletest/1.10.0/include
CXXFLAGS += -L/usr/local/Cellar/googletest/1.10.0/lib -lgtest -lgtest_main
...
CUDA_CXXFLAGS += -I/usr/local/Cellar/googletest/1.10.0/include
CUDA_CXXFLAGS += -L/usr/local/Cellar/googletest/1.10.0/lib -lgtest -lgtest_main
