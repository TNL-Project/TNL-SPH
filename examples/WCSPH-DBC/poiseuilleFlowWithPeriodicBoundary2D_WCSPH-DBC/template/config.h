...
class ParticleSystemConfig
{
   ...
   using CellIndexerType = TNL::Particles::SimpleCellIndex< spaceDimension, std::index_sequence< 1, 0 > >;
...
using ParticlesType = TNL::Particles::ParticlesLinkedList< ParticlesConfig, Device >;
