...
def solve( config_path: Path ):
    solver_path = bin_dir / f"poiseuilleFlowWithPeriodicBoundary2D_WCSPH-DBC_cuda"
...
if __name__ == "__main__":
    argparser = argparse.ArgumentParser(description="Poiseuille flow with open boundary example")
