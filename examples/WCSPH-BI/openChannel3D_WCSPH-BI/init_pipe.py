                ...
                for z in range( inlet_pipe_size_z_n ):
                    ...
                    if radius_xy < upperBound and radius_xy >= lowerBound:
                        for x in range( inlet_pipe_length_n ):
                            ...
                            # normal is pointing towards center with zero in x dim
                            n_y = -pos_y
                            n_z = -pos_z
                            n_size = np.sqrt( n_y**2 + n_z**2 )

                            normal_x.append( 0 )
                            normal_y.append( n_y / n_size )
                            normal_z.append( n_z / n_size )
...
if __name__ == "__main__":
    ...
    g.add_argument("--h-coef", type=float, default=1.7, help="smoothing length coefitient")
    ...
    g.add_argument("--n-boundary-layers", type=int, default=1, help="number of boundary layers")
