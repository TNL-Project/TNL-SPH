...
cp damBreak3D_WCSPH-BI_Def_template.xml damBreak3D_WCSPH-BI_Def.xml
sed -i "s/resolutionPlaceholder/${initalParticleSpacing}/" damBreak3D_WCSPH-BI_Def.xml
if [ $? -ne 0 ] ; then echo "Unable to set DualSPHysics configuration file."; exit 1 ; fi

#Setup and run the DualSPhysics GenCase
export name=damBreak3D_WCSPH-BI
...
mv ${dirout}/damBreak3D_WCSPH-BI_Fluid.vtk ${sources}/dambreak_fluid_dp${initalParticleSpacing}.vtk
mv ${dirout}/damBreak3D_WCSPH-BI_Bound.vtk ${sources}/dambreak_bound_dp${initalParticleSpacing}.vtk
mv ${dirout}/damBreak3D_WCSPH-BI_Normals.vtk ${sources}/dambreak_normals_dp${initalParticleSpacing}.vtk
