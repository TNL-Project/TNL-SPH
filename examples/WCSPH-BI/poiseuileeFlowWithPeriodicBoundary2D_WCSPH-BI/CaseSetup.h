...
using SPHModel = TNL::ParticleSystem::SPH::WCSPH_BI< ParticlesSys, SPHParams >;
...
int main( int argc, char* argv[] )
{
   ...
   while( timeStepping.runTheSimulation() )
   {
      ...
      log.writeParameter( "Update periodic BC (copy data)...", "Done." );
      ...
      log.writeParameter( "Update periodic BC (move)...", "Done." );
