...
numberOfBoundaryLayers = 1
numberOfBufferBoundaryLayers = 4
...
inletBufferLayers = numberOfBufferBoundaryLayers
...
inlet2BufferLayers = numberOfBufferBoundaryLayers
...
boundary_normals = np.array( ( normal_rx, normal_ry, normal_rz ), dtype=float ).T #!!
...
boxToWrite = saveParticlesVTK.create_pointcloud_polydata( boundary_r, boundary_v, boundary_rho, boundary_p, boundary_ptype, normals=boundary_normals )
