...
using ParticleSys = TNL::ParticleSystem::ParticlesLinkedList< ParticlesParams::ParticlesConfig, SimulationControl::DeviceType >;

/**
 * Include particular formulation of SPH method.
 */
#include <SPH/Models/WCSPH_BI/Interactions.h>
using SPHModel = TNL::ParticleSystem::SPH::WCSPH_BI< ParticleSys, SPHParams::SPHConfig >;
...
using Writer = TNL::ParticleSystem::Writers::VTKWriter< ParticleSys >;
using SimulationReaderType = TNL::ParticleSystem::ReadParticles< ParticlesParams::ParticlesConfig, Reader >;

/**
 * Import additional tools - boundaryCorrections
 */
using BoundaryCorrection = TNL::ParticleSystem::SPH::ElasticBounce< ParticleSys, SPHParams::SPHConfig >;
